...
var map = {
	...
	"../pages/home-pop-over/home-pop-over.module": [
		264,
		7
	],
	...
	"../pages/new-wallet/new-wallet.module": [
		268,
		3
	],
	"../pages/wallet-detail-manage/wallet-detail-manage.module": [
		269,
		2
	],
	"../pages/wallet-detail-transaction/wallet-detail-transaction.module": [
		270,
		1
	],
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["e" /* IonicModule */].forRoot(__WEBPACK_IMPORTED_MODULE_3__app_component__["a" /* MyApp */], {}, {
                links: [
                    ...
                    { loadChildren: '../pages/home-pop-over/home-pop-over.module#HomePopOverPageModule', name: 'HomePopOverPage', segment: 'home-pop-over', priority: 'low', defaultHistory: [] },
                    ...
                    { loadChildren: '../pages/new-wallet/new-wallet.module#NewWalletPageModule', name: 'NewWalletPage', segment: 'new-wallet', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/wallet-detail-manage/wallet-detail-manage.module#WalletDetailManagePageModule', name: 'WalletDetailManagePage', segment: 'wallet-detail-manage', priority: 'low', defaultHistory: [] },
                    { loadChildren: '../pages/wallet-detail-transaction/wallet-detail-transaction.module#WalletDetailTransactionPageModule', name: 'WalletDetailTransactionPage', segment: 'wallet-detail-transaction', priority: 'low', defaultHistory: [] },
